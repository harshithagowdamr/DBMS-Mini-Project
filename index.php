	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">
		 <div class="col-md-4 about-grids">
			 ...
			 <p>Sometimes, our bodies feel discomfort because we're busy working hard. We try to minimize our discomfort by taking short breaks to relax. Doing this helps us feel better and happier, even when things get tough. But sometimes, we might feel guilty for not doing enough, even though we're trying our best.  </p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4><span class="icon2"></span>Our Mission</h4>
			 <p>We want to make sure that tourism helps the people who live in the area by stopping unfair practices and making tourism better. We work hard to achieve this. Sometimes, it's challenging, but we're committed to making things right.</p>
		 </div>
		 <div class="col-md-4 about-grids">
			 <h4><span class="icon3"></span>Safety Information</h4>
			 <p>I feel pain and suffering sometimes, but I try to do my best at work. Although it's hard, I'm working towards something good. Sometimes I might make mistakes, but I'm trying my best.</p>
